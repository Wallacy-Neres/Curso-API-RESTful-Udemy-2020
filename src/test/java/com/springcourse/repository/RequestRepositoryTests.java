...
public class RequestRepositoryTests {
	...
	public void AsaveTest() {
		...
		Request crestedRequest = requestRepository.save(request);

		assertThat(crestedRequest.getId()).isEqualTo(1L);
	}
	...
	public void updateTest() {
		...
		Request request = new Request(1L, "Novo Laptop HP", "Pretendo obter um laptop HP, de Ram 16gb", null,
				RequestState.OPEN, owner, null);
